...
import (
	...
	"github.com/pubgo/tikdog/ent/predicate"
)
...
func Age(v int) predicate.Example {
	return predicate.Example(func(s *sql.Selector) {
...
func AgeEQ(v int) predicate.Example {
	return predicate.Example(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldAge), v))
	})
}
...
func AgeNEQ(v int) predicate.Example {
	return predicate.Example(func(s *sql.Selector) {
...
func AgeIn(vs ...int) predicate.Example {
...
func AgeNotIn(vs ...int) predicate.Example {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func AgeGT(v int) predicate.Example {
	return predicate.Example(func(s *sql.Selector) {
...
func AgeGTE(v int) predicate.Example {
	return predicate.Example(func(s *sql.Selector) {
...
func AgeLT(v int) predicate.Example {
	return predicate.Example(func(s *sql.Selector) {
...
func AgeLTE(v int) predicate.Example {
	return predicate.Example(func(s *sql.Selector) {
